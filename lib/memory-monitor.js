...
class MemoryMonitor extends EventEmitter {
  ...
  updateStats(entry) {
    ...
    this.stats.averageHeap =
      (this.stats.averageHeap * (n - 1) + entry.heapUsed) / n;
   ...
   * @param {Array} samples - Array of memory usage samples with rss property
   * @returns {boolean} True if memory shows steady growth (>70% increases)
   */
