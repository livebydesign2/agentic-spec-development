...
class WorkflowStateManager {
  ...
  async assignTask(specId, taskId, agentType, options = {}) {
    ...
    try {
      ...
      if (!frontmatterResult.success) {
        console.warn(`Failed to update frontmatter for ${specId}: ${frontmatterResult.error}`);
      }
  ...
  async completeSubtask(specId, taskId, subtaskId, options = {}) {
    ...
    try {
      ...
      if (!frontmatterResult.success) {
        console.warn(`Failed to update subtask frontmatter for ${specId}: ${frontmatterResult.error}`);
      }
  ...
  async batchUpdateSpecFrontmatter(updates, options = {}) {
    ...
    try {
      ...
      const result = await this.frontmatterSync.batchUpdateSpecs(fileUpdates, options);
