...
class ContextGatherer {
  ...
  async calculateContextRelevance(context, agentType) {
    ...
    const fileRelevance = this.calculateFileRelevance(context.relatedFiles, agentType);
  ...
  async findAdditionalRelevantFiles(task, agentType, projectRoot) {
  ...
  calculateFileRelevance(relatedFiles, agentType) {
  ...
  calculateDependencyRelevance(dependencies, agentType) {
