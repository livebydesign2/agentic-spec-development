...
describe('FileWatchers', () => {
  ...
  beforeEach(async () => {
    ...
    testDir = await fs.mkdtemp(
      path.join(os.tmpdir(), 'asd-filewatchers-test-')
    );
  ...
  describe('YAML File Watching', () => {
    ...
    test(
      'should detect YAML file changes',
      async () => {
...
This is a test feature.`;
    ...
    test(
      'should detect YAML file modifications',
      async () => {
        const yamlFile = path.join(
          testDir,
          'docs',
...
# Modified content`;
    ...
    test(
      'should detect YAML file deletions',
      async () => {
        const yamlFile = path.join(
          testDir,
          'docs',
    ...
    test(
      'should extract spec information from YAML files',
      async () => {
        const yamlFile = path.join(
          testDir,
          'docs',
...
# Feature with tasks`;
  ...
  describe('JSON State File Watching', () => {
    ...
    test(
      'should detect JSON state file changes',
      async () => {
    ...
    test(
      'should extract state information from JSON files',
      async () => {
...
# Test`;
        ...
        const changeEvents = eventSpy.file_change.mock.calls.filter(
          (call) =>
            call[0].changeType === 'change' && call[0].filePath === yamlFile
        );
  ...
  describe('Performance Monitoring', () => {
    ...
    test(
      'should track detection performance',
      async () => {
        const yamlFile = path.join(
          testDir,
          'docs',
...
# Performance test`;
  ...
  describe('Status and Statistics', () => {
    ...
    test(
      'should update statistics as events are processed',
      async () => {
        await fileWatchers.initialize();
        await new Promise((resolve) => setTimeout(resolve, 1000));
  ...
  describe('Pause and Resume', () => {
    ...
    test(
      'should pause and resume watching',
      async () => {
        // Test pause
        fileWatchers.pause();
  ...
  describe('Shutdown', () => {
    ...
    test(
      'should clear debounce timers on shutdown',
      async () => {
        await fileWatchers.initialize();
        await new Promise((resolve) => setTimeout(resolve, 1000));
